...
### Introduction:
As a kid I liked to invent board games. One was like monopoly, except that you got to buy stocks. For each stock there was a column of small cards, each card representing a share, and you could buy them if you landed on the right square. The first card's position indicated an offer of 100. The second card indicated a price of 130, and so forth. First in, best dressed. 
